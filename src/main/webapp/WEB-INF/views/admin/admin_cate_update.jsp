...
<br><br>
<form name="f" method="post" action="admin_cate_update.do"  onsubmit="return cateCheck();">
<input type="hidden" name="cnum" value="${getCategory.cnum}"/>
<table border="0" width="50%" class="outline2">
	<div align="center">
		<caption> 카테고리수정 </caption>
		<tr>
         ...
         <tr>
            <th width="40%" bgcolor="#ebebeb"> 소분류 코드 </th>
             <td><input type="text" id="cscode" name="cscode" class="box" value="${getCategory.cscode}"></td>
         </tr>
         <tr>
            <th width="40%" bgcolor="#ebebeb"> 소분류 </th>
            <td><input type="text" id="csname" name="csname" class="box" value="${getCategory.csname}"></td>
         </tr>
         <tr>
