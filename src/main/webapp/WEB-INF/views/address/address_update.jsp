...
<link rel="stylesheet" type="text/css"
   href="resources/css/style_address.css">
<script
...
<div data-v-2077f721 class="layer_container">
   <a data-v-2969fd09="" data-v-2077f721="" href="#"
     ...
     <form name="f" method="post" action="address_update.do?mem=${getAddress.mem}" onsubmit="">
   <div data-v-2077f721="" class="layer_header">
      <h2 data-v-2969fd09="" data-v-2077f721="" class="title">주소 변경</h2>
   </div>
   <div data-v-2077f721="" class="layer_content">
      <div data-v-2969fd09="" data-v-2077f721="" class="delivery_bind">
         <div data-v-2969fd09="" data-v-2077f721="" class="delivery_input">
            ...
            <div data-v-5ee806c3="" data-v-2969fd09="" class="input_box"
               ...
               <div data-v-5ee806c3="" class="input_item">
                  <input data-v-5ee806c3="" type="tel" placeholder="- 없이 입력" oninput="autoHyphen2(this)" maxlength="13"
                     autocomplete="off" class="input_txt" name="tel" id="tel">
               </div>
         ...
         <div data-v-2969fd09="" data-v-2077f721="" class="delivery_check">
            <div data-v-384af6ef="" data-v-2969fd09="" class="checkbox_item"
               data-v-2077f721="">
               <input data-v-384af6ef="" id="check1" type="checkbox" name="" class="blind">
               <label data-v-384af6ef="" for="check1" class="check_label">
               <svg data-v-384af6ef="" xmlns="http://www.w3.org/2000/svg"
                              class="icon sprite-icons ico-check-inactive"></svg>
                      <!----></label>
            </div>
         </div>
      </div>
      ...
      <div data-v-2969fd09 data-v-2077f721 class="layer_btn">
         <a href="javascript:closeTabClick()" data-v-14ec1f2e data-v-2969fd09 
            ...
            <a data-v-14ec1f2e data-v-2969fd09 onClick="javascript:insertAddress()"
