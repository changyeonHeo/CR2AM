...
<script src="resources/js/addressTotal.js"></script>
...
<script>
   $(function() {
      ...
      $('.tab_area .item_link:first').on('click', function() {
         ...
         $("span.title_txt").text("구매 입찰하기");
         $("button[class='btn full solid false']").text("구매 입찰 계속");
      })
      $('.tab_area .item_link:last').on('click', function() {
         $(this).parent('.item').addClass('on').attr({'aria-selected' : 'true'});
         $(this).parent('.item').siblings('.item').removeClass('on').attr({
            'aria-selected' : 'false'});
         ...
         $("span.title_txt").text("즉시 구매하기");
         $("button[class='btn full solid false']").text("즉시 구매 계속");
      })
      $(".item_link:first").trigger('click');
   });
   ...
   function toSell() {
      ...
      if(whatyoupay == "" || whatyoupay == "-"){
         ...
         if ($(".price_now .active_input").find("span.amount").length == 1) {
            location.href = "toBuyFinal.do?price=" + whatyoupay + "&pnum="
               + $("#pnum").val();
         } else {
            location.href = "toBuyFinal.do?price=" + whatyoupay + "&pnum="
            ...
            <div class="product_info">
               ...
               <div data-v-6805fc8a="" data-v-b57d39f0="" class="product"
                  ...
                  <picture data-v-44ba780a="" data-v-6805fc8a=""
                     ...
                     src="/files/${dto.pimage}" class="image full_width">
                  </picture>
                  <!---->
                  <!---->
                  <!---->
         ...
         <%--                     <div class="content_wapper">
                        <div class="content">
                            <div class="product_info_area">
                                <div class="product_info">
                                    <div class="product">
                                        <img src="resources/img/${dto.pimage}" class="image full_width">
                                    </div>
                                    <div class="product_detail">
                                        <strong class="model_detail">${dto.pcode}</strong>
                                        <p class="model_title">${dto.pname}</p>
                                        <p class="model_ko">${dto.pname}</p>
...
<div data-v-2077f721="" data-v-2969fd09="" data-v-0eedeb11="" class="layer_delivery layer md" style="display: none;">
        ...
        <div data-v-2077f721="" class="layer_content" style="display: none;">
            ...
            <div class="instant_group">
               <div class="tab_area buy_tab">
                  <ul class="tab_list">
                     <li role="tab" aria-selected="false" class="item" aria-controls="11">
                        <a class="item_link" aria-controls="11">구매 입찰</a>
                     </li>
                     <li role="tab" aria-selected="true" class="item on"aria-controls="12">
                        <a class="item_link" aria-controls="12">즉시 구매</a>
                     </li>
                  </ul>
               </div>
               ...
               <div class="buy_total_confirm" is-instant="true">
                  <div class="price_total">
                     <dl class="price_box">
                        ...
                        <dd class="price">
                           <span class="amount">${dto.pprice-charge}</span> 
                  ...
                  <div class="btn_confirm">
                     ...
                     <button type="button" class="btn full solid false"
                        onclick="toSell()">즉시 구매 계속</button>
                  </div>
               </div>
            </div>
         </div>
