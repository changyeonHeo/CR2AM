        ...
        <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
                        ...
                        $(function () {
                            ...
                            $("#buyButton").on('click', function () {
                                ...
                                location.href = "buy_checklist.do?pnum=" + $("input[id='pnum']").val() + "&size=" + $(".select_item[aria-selected='true']").find("span.size").text() + "&price=" + $(".select_item.active").find("span.price").text();
                            })
                                        ...
                                        for (var i = 0; i < sizelist.length; i++) {
                                            ...
                                            if (pricelist[i] == 0) {
                                                $("ul[class='select_list grid_list grid_2']").append("<li class='select_item'><button role='button' aria-selected='false' class='select_link sell'><div class='link_inner'><span class='size'>"
                                                    + sizelist[i]
                                                    + "</span><span id='pprice' class='price'>구매입찰 가격자리 </span></div></button></li>");
                                            } else {
                                                $("ul[class='select_list grid_list grid_2']").append("<li class='select_item'><button role='button' aria-selected='false' class='select_link sell'><div class='link_inner'><span class='size'>"
                                                    + sizelist[i]
                ...
                <div class="sell_before">
                    <div class="sell_before_check">
                        <div class="product_info">
                            ...
                            <div class="product_detail" width="100%">
                                ...
                                <p id="pgender" class="translated_name">${dto.pgender}</p>
                    ...
                    <div class="sell_before_select">
                        ...
                        <div class="order_btn_area">
                            <button class="btn_order order_buy buy clickable" id="buyButton">
                                <div class="box_buycho">
