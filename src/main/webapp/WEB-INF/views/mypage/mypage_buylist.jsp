        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    $("img[class='list_item_img']").eq(i).attr("src","/img/"+result[i].rimage);
...
<div data-v-3b1b5d32="" class="v-portal" style="display: none;"></div>
         ...
         <div data-v-2cbb289b="" data-v-3b1b5d32="" class="purchase_list_tab detail_tab">
            <div data-v-2cbb289b="" class="tab_item tab_on">
               <a data-v-2cbb289b="" href="#" class="tab_link">
            ...
            <div data-v-2cbb289b="" class="tab_item">
               <a data-v-2cbb289b="" href="buy_ing.do" class="tab_link">
               <dl data-v-2cbb289b="" class="tab_box">
                     <dd data-v-2cbb289b="" class="count">0</dd>
            ...
            <div data-v-2cbb289b="" class="tab_item">
               <a data-v-2cbb289b="" href="buy_end.do" class="tab_link">
               <dl data-v-2cbb289b="" class="tab_box">
                     <dd data-v-2cbb289b="" class="count">0</dd>
         ...
         <div data-v-8c632d9a="" data-v-3b1b5d32=""
            class="purchase_list bidding bid" style="display: none;"></div>
